...
class UnitTests(absltest.TestCase):
    def test_json_controlled_generation(self):
        ...
        result = model.generate_content(
            """Generate an exaustive description of what the following C/C++ function could be used for. Don't describe parameters neither returned data. Don't use special characters.
            ...
            generation_config=genai.GenerationConfig(
                response_mime_type="application/json", response_schema=str, candidate_count=1),
        )
        print(result.text)
...
class Gemini():
    ...
    def generate_description(self, func_str: str) -> str:
        prompt: str = "Generate an exaustive description of what the following C/C++ function could be used for. Don't describe parameters neither returned data. Don't use special characters."
