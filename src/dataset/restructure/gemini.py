...
class UnitTests(absltest.TestCase):
    def test_json_fdoc_generation(self):
        # get API key from .zshrc
        genai.configure(api_key=os.environ["GEMINI_API_KEY"])
