...
from typing import Any, Callable, Iterable, Literal, TypedDict, TypeVar, cast

from rich import box
from rich.align import Align, AlignMethod
from rich.console import Console, Group, HighlighterType, JustifyMethod, OverflowMethod
...
def rich_exception(show_locals: bool = False):
